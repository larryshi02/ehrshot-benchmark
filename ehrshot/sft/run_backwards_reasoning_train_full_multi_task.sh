...
OUTPUT_DIR="./data_gpt-5-mini"
SFT_DATASET_DIR="./data_gpt-5-mini"
...
# Build the command
CMD="python azure_backwards_reasoning_train_full_multi_task_pipeline.py \
...
if [ $? -eq 0 ]; then
    ...
    echo "Output files:"
    echo "  - Backwards reasoning traces: $OUTPUT_DIR/*_train_backwards_reasoning_large.json"
    echo "  - SFT datasets: $SFT_DATASET_DIR/*_train_sft_large.json"
else
