...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo ""
            echo "Options:"
            echo "  --data_dir DIR              Directory containing serialized task data (default: ehrshot/sft/serialized_multi_task_data)"
            echo "  --output_dir DIR            Output directory for selected cohorts (default: ehrshot/sft/rubric/cohorts)"
            echo "  --n_pos N                   Number of positive samples per task (default: 20)"
